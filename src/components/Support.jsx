...
import supportImg from '../assets/monk.jpeg'
  ...
  <div name='support' className='w-full mt-24'>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          <div className='px-4 py-12'>
              <h2 className='text-3xl pt-8 text-slate-300 uppercase text-center'>Banana</h2>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      ...
                      <h3 className='font-bold text-2xl my-6'>Banana</h3>
                  ...
                  <div className='bg-slate-100 pl-8 py-4'>
                      <p className='flex items-center text-amber-400'>Contact Us <ArrowSmRightIcon className='w-5 ml-2' /></p>
                  </div>
              </div>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <SupportIcon className='w-16 p-4 bg-amber-400 text-white rounded-lg mt-[-4rem]' />
                      <h3 className='font-bold text-2xl my-6'>Banana Banana</h3>
                      <p className='text-gray-600 text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi provident iure placeat blanditiis ea sint earum hic iste quibusdam exercitationem.</p>
                  </div>
                  <div className='bg-slate-100 pl-8 py-4'>
                      <p className='flex items-center text-amber-400'>Contact Us <ArrowSmRightIcon className='w-5 ml-2' /></p>
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      ...
                      <h3 className='font-bold text-2xl my-6'>Banana Banana Banana</h3>
                      <p className='text-gray-600 text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi provident iure placeat blanditiis ea sint earum hic iste quibusdam exercitationem.</p>
                  </div>
                  <div className='bg-slate-100 pl-8 py-4'>
                      <p className='flex items-center text-amber-400'>Contact Us <ArrowSmRightIcon className='w-5 ml-2' /></p>
